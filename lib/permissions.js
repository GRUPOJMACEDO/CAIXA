...
// Módulo Duplicidades: cada unidade cuida das próprias OS — Supervisão e
// Gerência (donos da unidade), mais Administrador/Diretor/Auditoria (visão
// geral). Auditoria só enxerga; não tem botão de check/recusar.
export function podeVerDuplicidades(cargo) {
  return [CARGOS.SUPERVISAO, CARGOS.GERENCIA, CARGOS.ADMINISTRADOR, CARGOS.DIRETOR, CARGOS.AUDITORIA].includes(cargo);
}
